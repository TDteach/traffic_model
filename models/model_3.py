...
class model_3(BasicModule):
    """
    In this model, some features will be excluded, like 'ip'
    I want to find out what has the most influence on the evaluation.
    """
    def __init__(self, feature_dim, hidden_dim, tagset_size, num_layers, cuda_support=True):
        super(model_4, self).__init__()
        self.hidden_dim = hidden_dim
        self.num_layers = num_layers
        self.sscuda_support = cuda_support
